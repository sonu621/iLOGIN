            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            <td><?= $row['id'] ?></td>
                            <td><img src="uploads/<?= $row['image'] ?>" alt="<?= $row['name'] ?>" class="preview_img" style="width: 50px; height: 50px;"></td>
                            <td><?= $row['name'] ?></td>
                            <td><?= $row['country'] ?></td>
                            <td><?= $row['gender'] ?></td>
                            <td>
    ...
    <form id="insertForm" action="server.php?action=insertData" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <div class="d-flex align-items-center">
                <img class="preview_img me-3" src="https://w7.pngwing.com/pngs/178/595/png-transparent-user-profile-computer-icons-login-user-avatars-thumbnail.png" alt="img" style="width: 50px; height: 50px;">
